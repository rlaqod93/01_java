...
* Class Name : DateEx03SimpleDateFoamt.java
* Description:
* Author: ITSC
* Since: 2022/02/22
* Version 0.1
...
public class DateEx03SimpleDateFormt {
	...
	public static void main(String[] args) {
		...
		// yy년 MM월 dd일 EE요일
		SimpleDateFormat sdf03 = new SimpleDateFormat("yy년 MM월 dd일 EE요일");
		Date today = new Date();

		System.out.println("yyyy-MM-dd HH:mm:ss.SSS: " + sdf01.format(today));
		System.out.println("MM-dd-yyyy: " + sdf02.format(today));
		System.out.println("yy년 MM월 dd일 EE요일" + sdf03.format(today));
